...
brick(1).min_x=-10.1e-3;
brick(1).min_y=-10.1e-3;
brick(1).min_z= 0;
brick(1).max_x= 10.1e-3;
brick(1).max_y= 10.1e-3;
brick(1).max_z= 1e-3;
...
Hx_sample=zeros(nxp1-21,ny-21,nz-91)  ;
Hy_sample=zeros(nx-21,nyp1-21,nz-91)  ;
Hz_sample=zeros(nx-21,ny-21,nzp1-91)  ;
Ex_sample=zeros(nx-21,nyp1-21,nzp1-91);
Ey_sample=zeros(nxp1-21,ny-21,nzp1-91);
Ez_sample=zeros(nxp1-21,nyp1-21,nz-91);
...
Hx_sample=Hx(10:end-10,10:end-10,90:end);
Hy_sample=Hy(10:end-10,10:end-10,90:end);
Hz_sample=Hz(10:end-10,10:end-10,90:end);
Ex_sample=Ex(10:end-10,10:end-10,90:end);
Ey_sample=Ey(10:end-10,10:end-10,90:end);
Ez_sample=Ez(10:end-10,10:end-10,90:end);
Hh_1(number/10)=figure
for ind=1:number_of_brick
hold on
...
colormap(mymap)
colorbar
[x,y,z]=meshgrid(xcoor(10:end-10),ycoor(10:ny-10), zcoor(90:end));
h=slice(x,y,z,Ex_sample,-0.0074,[],[])
h_p=slice(x,y,z,Ex_sample,[],-0.0074,[])
...
% for i=1:nzp1
% Ex_sample_2D(i)=Ex(nxp1/2,nyp1/2,i) ;
% end
% Hh_2(number/10)=figure
% hold on
% plot(zcoor,Ex_sample_2D)
% xlabel('z','fontsize', 12);ylabel('Ex','fontsize', 12);
% ylim([-1 1]);
% grid on
% savefig(Hh_2,'three_layer_non_dispersive_skin_fdtd_cpml_gaussian_3D_2D.fig')
 end
disp(number)
end