...
material_type(2).color=[1 0.87 0.68];
%a dielectric_2
...
title({'Ex'}); 
drawnow
savefig(Hh_1,'two_layer_non_dispersive_skin_fdtd_cpml_gaussian_3D_3D.fig')
...
ylim([-2.8*10^15 2.8*10^15]);
grid on
savefig(Hh_2,'two_layer_non_dispersive_skin_fdtd_cpml_gaussian_3D_2D.fig')
end
disp(number)
end